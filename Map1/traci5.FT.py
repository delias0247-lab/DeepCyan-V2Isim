# traci5.FT.py  (FULL FIXED VERSION)
# ✅ Fixes: "Could not access configuration 'RL.sumocfg'" + TraCI refused connection
# Works no matter where you run the script from, because it uses absolute paths.
