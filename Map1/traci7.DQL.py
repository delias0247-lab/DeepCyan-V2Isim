# dqn_traci_FIXED.py  (FULL VERSION)
# ✅ Fixes exactly like we did before:
# 1) RL.sumocfg path issues (absolute paths + chdir)
# 2) Traffic light "Node2 not known" (auto-detect TLS id + hard check)
# 3) Works with sumo (no GUI) + safe shutdown
# 4) Fixes the indentation bug in your code (state_size / model creation was inside to_array by mistake)
...
# -------------------------
BASE_DIR = Path(r"C:\Users\Edawi\OneDrive\Desktop\work\Map1")  # folder containing RL.sumocfg
