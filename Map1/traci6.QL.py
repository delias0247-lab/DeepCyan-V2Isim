# traci5.FT_RL_FIXED.py  (FULL VERSION)
# ✅ Fixes:
# 1) RL.sumocfg not found (uses absolute paths + chdir)
# 2) "Traffic light 'Node2' is not known" (auto-detect TLS id + hard check)
# 3) Adds clean startup checks + safe shutdown
